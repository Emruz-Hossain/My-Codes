/*এই  problem টা segment tree এর problem. তবে limit অনেক বড় (10e8). কিন্ত যেহেতু  total number of point 3*50000 এর বেশি হবেনা,তাই point গুলাকে
আগে convert করে acceptable limit এর মধ্যে আনতে হবে। আর converted point গুলা খুজে বেড় করতে binary search প্রয়োজন হবে।  */
