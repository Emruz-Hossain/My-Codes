...
int rec(int r,int c,int d)
{
    ...
    if(dp[r][c][d]>0)
        return dp[r][c][d];
    int p1=sx,p2=sx,p3=sx,p4=sx;
    if(c+1<n&&ss[r][c+1]=='.'&&visit[r][c+1]==0)
    {
         visit[r][c+1]=1;
        p1=rec(r,c+1,4);
        visit[r][c+1]=0;
    ...
    if(r+1<n&&ss[r+1][c]=='.'&&visit[r+1][c]==0)
    {
        visit[r+1][c]=1;
        p2=rec(r+1,c,1);
         visit[r+1][c]=0;
    ...
    if(c-1>=0&&ss[r][c-1]=='.'&&visit[r][c-1]==0)
    {
         visit[r][c-1]=1;
        p3=rec(r,c-1,2);
         visit[r][c-1]=0;
    ...
    if(r-1>=0&&ss[r-1][c]=='.'&&visit[r-1][c]==0)
    {
         visit[r-1][c]=1;
        p4=rec(r-1,c,3);
         visit[r-1][c]=0;
