...
ll ar[6*100005],br[6*100005],cr[6*100005],dr[6*100005],er[6*100005];
ll Find(ll val,ll m)
{
    ll l=0,h=m,mid;
    while(l<=h)
...
int main()
{
   ...
   ll a,b,c,d,h,m,n,p,x,y,z,i,j,k,l,q,r,t,tmp;
   readl2(n,k);
   mem(br,0);
   mem(er,0);
   for(i=0;i<n;i++)
