...
int ar[505],br[505],cr[505],extra1[505],extra2[505];
int main()
{
...
//   for(i=1;i<n;i++)
//   {
//       extra1[i]=extra1[i-1]+(br[i]-ar[i]);
//   }
//   extra2[n-1]=0;
//   for(i=n-2;i>=0;i--)
//   {
//       extra2[i]=extra2[i+1]+(cr[i]-ar[i]);
//   }
//   sm=inf;
//   for(i=0;i<n-1;i++)
//   {
//       if(sm>extra1[i]+extra2[i+1])
//       {
//           sm=extra1[i]+extra2[i+1];
//           cnt=i;
//       }
//
//   }
