...
int main()
{
  ...
  for(i=0;i<l;i++)
  {
      ...
      while(S.size()>1)
      {
          ...
          top2=S.top();
          S.pop();
          if((top2=='['&&top==']')||(top2=='{'&&top=='}')||(top2=='<'&&top=='>')||(top2=='('&&top==')'))
            continue;
          else if((top2=='('&&top=='}')||(top2=='('&&top==']')||(top2=='('&&top=='>')||(top2=='['&&top==')')||(top2=='['&&top=='}')||(top2=='['&&top=='>')||(top2=='{'&&top==')')||(top2=='{'&&top==']')||(top2=='{'&&top=='>')||(top2=='<'&&top==')')||(top2=='<'&&top==']')||(top2=='<'&&top=='}'))
            cnt++;
          else
          {
              S.push(top2);
