...
int main()
{
   ...
   ll a,b,c,d,h,m,n,p,x,y,i,j,k,l,q,r,t,cnt,sm,tmp,id1,id21,id22;
   sf("%lld",&n);
   sm=0;
   for(i=0;i<n;i++)
   {
       ...
       V.push_back(st(a,b,c,i));
       V.push_back(st(b,a,c,i));
       V.push_back(st(b,c,a,i));
       V.push_back(st(c,b,a,i));
       V.push_back(st(a,c,b,i));
       V.push_back(st(c,a,b,i));
   }
   ...
   for(i=1;i<V.size();i++)
   {
       st aa=V[i-1];
       st bb=V[i];
       if(aa.a==bb.a&&aa.b==bb.b&&aa.idx!=bb.idx)
       {
           d=min(aa.a,min(aa.b,aa.c+bb.c));
           if(sm2<d)
           {
               sm2=d;
               id21=aa.idx;
