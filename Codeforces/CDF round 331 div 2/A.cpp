...
int main()
{
  ...
  else
  {
      if(n==2)
      {
          ...
          {
              pf("%d\n",abs(ar[0].x-ar[1].x)*abs(ar[0].y-ar[1].y));
          }
          else
            pf("-1\n");
      }
      else if(n==3)
      {
          ...
          else if(ar[0].x!=ar[2].x&&ar[0].y!=ar[2].y)
             pf("%d\n",abs(ar[0].x-ar[2].x)*abs(ar[0].y-ar[2].y));
          else if(ar[1].x!=ar[2].x&&ar[1].y!=ar[2].y)
             pf("%d\n",abs(ar[1].x-ar[2].x)*abs(ar[1].y-ar[2].y));
             else pf("-1\n");
      }
      else
      {
          if(ar[0].x!=ar[1].x&&ar[0].y!=ar[1].y)
             ...
             pf("%d\n",abs(ar[0].x-ar[2].x)*abs(ar[0].y-ar[2].y));
           else  if(ar[0].x!=ar[3].x&&ar[0].y!=ar[3].y)
             pf("%d\n",abs(ar[0].x-ar[3].x)*abs(ar[0].y-ar[3].y));
      }
  }
