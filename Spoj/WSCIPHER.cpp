...
int main()
{
   ...
   while(1)
   {
       ...
       if(a==0&&b==0&&c==0)
        break;
       sf("%s",&ss);
       deque<char>group1,group2,group3;
       l=strlen(ss);
       for(i=0;i<l;i++)
       {
           if(ss[i]>='a'&&ss[i]<='i')
           {
               group1.push_back(ss[i]);
               pos[i]=1;
           }
           else if(ss[i]>='j'&&ss[i]<='r')
           {
               group2.push_back(ss[i]);
               pos[i]=2;
           }
           else
           {
               group3.push_back(ss[i]);
               pos[i]=3;
           }
       }
       for(i=0;i<a;i++)
       {
           char ch=group1.back();
           group1.pop_back();
           group1.push_front(ch);
       }
       for(i=0;i<b;i++)
       {
           char ch=group2.back();
           group2.pop_back();
           group2.push_front(ch);
       }
       for(i=0;i<c;i++)
       {
           char ch=group3.back();
           group3.pop_back();
           group3.push_front(ch);
       }
       for(i=0;i<l;i++)
       {
           if(pos[i]==1)
