...
int main()
{
   ...
   int a,b,c,d,h,m,n,p,x,y,i,j,k,l,q,r,t,cnt,sm,tmp,days,month,year;
   ...
   while(t--)
   {
      ...
      month=0;
      year=2012;
      while(!(days==d&&month==m&&year==y))
      {
          cnt++;
          cnt=cnt%7;
          days++;
          if(days>Month[month]+isLeapYear(month,year))
          {
              days=1;
              month++;
          }
