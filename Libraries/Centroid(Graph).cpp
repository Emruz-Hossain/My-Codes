 ...
 **************************************/
 ...
 /*****************************Problem*******************************
 Given a tree with n vertex. Find if each of it can be made centroid
 using at most one eadge replacement . A node is said to be centroid
 if all of its neighbour has at most n/2 vertex.
*********************************************************************/
 #include<bits/stdc++.h>
 using namespace std;
