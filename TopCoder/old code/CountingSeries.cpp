...
long long countThem(long long a, long long b, long long c, long long d, long long upperBound)
{
    long long ret=0,x;
        if(upperBound>=a)
            ret=(long long)(((upperBound-a)/b)+1);
    x=c;
    while(x<=upperBound)
    {
        if(x>=a&&(x-a)%b==0)
...
// BEGIN CUT HERE
	...
	void test_case_0() { long long Arg0 = 3LL; long long Arg1 = 2LL; long long Arg2 = 1LL; long long Arg3 = 9LL; long long Arg4 = 95LL; long long Arg5 = 48LL; verify_case(0, Arg5, countThem(Arg0, Arg1, Arg2, Arg3, Arg4)); }
