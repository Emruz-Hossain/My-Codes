...
int main()
{
        //freopen("The_Crazzy_Mathematician_output.txt","w",stdout);
        //freopen("The_Crazzy_Mathematician_input.txt","r",stdin);
   ...
   for(x=1;x<=t;x++)
   {
       ...
       if(detected)
        pf("Case %d: Happy train journey.\n",x);
       else
        pf("Case %d: Happy plane journey.\n",x);
   }
